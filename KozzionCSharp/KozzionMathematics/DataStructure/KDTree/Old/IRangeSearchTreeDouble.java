 ...
 * </p>
 */
public interface IRangeSearchTreeDouble<LabellingType> extends Map<DoubleVector, LabellingType>
{
    /**
     ...
     */
    public Iterator<Map.Entry<DoubleVector, LabellingType>> iterator(DoubleVector lower, DoubleVector upper);
