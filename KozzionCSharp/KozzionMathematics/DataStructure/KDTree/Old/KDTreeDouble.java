 ...
 * </p>
 */
public class KDTreeDouble<LabellingType> implements IRangeSearchTreeDouble<LabellingType>, Serializable
{
    /**
     * 
     */
     ...
     */
    public KDTreeDouble(final int dimensions)
    {
        assert (dimensions > 0);
    ...
    {
        return (getNode((DoubleVector) key) != null);
    }
     ...
     */
    @Override
    public Set<Map.Entry<DoubleVector, LabellingType>> entrySet()
    {
    ...
    {
        final KdNode node = getNode((DoubleVector) point);
        if (node == null)
        {
            return null;
        }
     ...
     */
    @Override
    public Set<DoubleVector> keySet()
    {
        return new KeySet();
    }
     ...
     */
    @Override
    public LabellingType put(final DoubleVector point, final LabellingType value)
    {
        final KdNode [] parent = new KDTreeDouble.KdNode [1];
        KdNode node = get_node(point, parent);
        ...
        else
        {
            ...
            else
            {
                ...
                if (point.get_coordinate(discriminator).compareTo(parent[0].d_point.get_coordinate(discriminator)) >= 0)
                {
     ...
     */
    @Override
    public void putAll(final Map<? extends DoubleVector, ? extends LabellingType> map)
    {
        for (final Map.Entry<? extends DoubleVector, ? extends LabellingType> pair : map.entrySet())
        {
    ...
    {
        final KdNode [] parent = new KDTreeDouble.KdNode [1];
        KdNode node = get_node((DoubleVector) key, parent);
        LabellingType old = null;
    ...
    @Override
    public Iterator<Map.Entry<DoubleVector, LabellingType>> iterator(final DoubleVector lower, final DoubleVector upper)
    {
    ...
    final class NodeComparator implements Comparator<KdNode>, Serializable
    {
        ...
        {
            return n1.d_point.get_coordinate(_discriminator).compareTo(n2.d_point.get_coordinate(_discriminator));
        }
    }

    final class KdNode implements Map.Entry<DoubleVector, LabellingType>, Serializable
    {
        private static final long serialVersionUID = 1L;

        int                       d_discriminator;
        DoubleVector              d_point;
        LabellingType             d_value;
        KdNode                    d_low;
        KdNode                    d_high;

        KdNode(final int discriminator, final DoubleVector point, final LabellingType value)
        {
            d_point = point;
            d_value = value;
            d_low = null;
    ...
    final class MapEntryIterator implements Iterator<Map.Entry<DoubleVector, LabellingType>>
    {
        LinkedList<KdNode> _stack;
        KdNode             _next;
        DoubleVector       _lower, _upper;

        MapEntryIterator(final DoubleVector lower, final DoubleVector upper)
        {
        ...
        @Override
        public Map.Entry<DoubleVector, LabellingType> next()
        {
    ...
    final class KeyIterator implements Iterator<DoubleVector>
    {
        ...
        {
            final Map.Entry<DoubleVector, LabellingType> next = iterator.next();
    ...
    abstract class CollectionView<E> implements Collection<E>
    {
        ...
        public int hashCode()
        {
            return KDTreeDouble.this.hashCode();
        }

        @Override
        public boolean isEmpty()
        {
            return KDTreeDouble.this.isEmpty();
        }

        @Override
        public int size()
        {
            return KDTreeDouble.this.size();
        }
    ...
    final class MapEntrySet extends SetView<Map.Entry<DoubleVector, LabellingType>>
    {
        @Override
        ...
        @Override
        public Iterator<Map.Entry<DoubleVector, LabellingType>> iterator()
        {
        ...
        public boolean remove(final Object o) throws ClassCastException
        {
            ...
            KDTreeDouble.this.remove(e.getKey());
        ...
        public boolean retainAll(final Collection<?> c) throws ClassCastException
        {
            for (final Object o : c)
            {
                if (contains(o))
                {
                    final Collection<Map.Entry<DoubleVector, LabellingType>> col = (Collection<Map.Entry<DoubleVector, LabellingType>>) c;
                    clear();
                    for (final Map.Entry<DoubleVector, LabellingType> e : col)
                    {
    ...
    final class KeySet extends SetView<DoubleVector>
    {

        @Override
        public boolean contains(final Object o) throws ClassCastException, NullPointerException
        {
            return KDTreeDouble.this.containsKey(o);
        }
        ...
        public boolean retainAll(final Collection<?> c) throws ClassCastException
        {
            final HashMap<DoubleVector, LabellingType> map = new HashMap<DoubleVector, LabellingType>();
            final int size = size();
    ...
    final class ValueCollection extends CollectionView<LabellingType>
    {
        ...
        public boolean contains(final Object o) throws ClassCastException, NullPointerException
        {
            return KDTreeDouble.this.containsValue(o);
        }
        ...
        public boolean remove(final Object o) throws ClassCastException
        {
            ...
            if (node != null)
            {
                KDTreeDouble.this.remove(node.getKey());
                return true;
            }
    ...
    KdNode get_node(final DoubleVector point, final KdNode [] parent)
    {
        int discriminator;
    ...
    KdNode getNode(final DoubleVector point)
    {
        return get_node(point, null);
    }
    ...
    KdNode getMinimumNode(final KdNode node, final KdNode p, final int discriminator, final KdNode [] parent)
    {
        ...
        else
        {
            ...
            final KdNode [] plow = new KDTreeDouble.KdNode [1], phigh = new KDTreeDouble.KdNode [1];
    ...
    boolean isInRange(final DoubleVector point, final DoubleVector lower, final DoubleVector upper)
    {
        ...
        {
            final int dimensions = point.get_dimension_count();
