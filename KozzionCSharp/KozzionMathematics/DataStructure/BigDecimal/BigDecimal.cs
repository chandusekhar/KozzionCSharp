...
namespace KozzionMathematics.DataStructure.BigDecimal
{
    ...
    {
        public static BigDecimal NegativeInfinity { get; set; }
        public static BigDecimal PositiveInfinity { get; set; }
        public static BigDecimal MaxValue { get; set; }
        public static BigDecimal MinValue { get; set; }    
        public static BigDecimal NaN { get; set; }
        ...
        public static BigDecimal LogE(BigDecimal value)
        {
 	        throw new NotImplementedException();
        }
        ...
        public BigDecimal Modulo(BigDecimal value_1)
        {
            throw new NotImplementedException();
        }
