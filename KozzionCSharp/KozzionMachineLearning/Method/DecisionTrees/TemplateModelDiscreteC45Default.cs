...
{
    public class TemplateModelDiscreteC45Default : ATemplateModelDiscrete<double, int>
    {
        public override IModelDiscrete<double, int> GenerateModelDiscrete(IDataSet<double, int> training_set)
        {
            ...
            int[] outputs = training_set.GetLabelDataColumn(0);
            ...
            DecisionTree tree = new DecisionTree(variables, training_set.DataContext.LabelDescriptors[0].ValueCount);
            ...
            return new ModelDiscreteC45Default(training_set.DataContext, tree);
        }
    }
}
