...
{
    [Serializable()]
	public class ImageRaster1D<ElementType> : ImageRaster<IRaster1DInteger, ElementType>, IImageRaster1D<ElementType>
	{
		public ImageRaster1D() :
			base(new Raster1DInteger(1))
		{
		
		}
        public ImageRaster1D(
            int size_0) :
            base(new Raster1DInteger(size_0))
        {
        }

        public ImageRaster1D(IRaster1DInteger raster)
            : this(raster.Size0)
        {
		...
		public ImageRaster1D(
            ...
            ElementType[] image,
            bool copy_array):
			base(new Raster1DInteger(size_0), image, copy_array)
		{
		...
		public ImageRaster1D(
			  int size_1,
              ElementType value) :
			base(new Raster1DInteger(size_1), value)
		{		

		}

        public ImageRaster1D(IRaster1DInteger raster, ElementType value)
            : this(raster.Size0, value)
        {
